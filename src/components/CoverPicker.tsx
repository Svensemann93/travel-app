    ...
    >
      ...
      >
        <div className="flex shrink-0 items-center justify-between border-b border-slate-100 p-4">
          <h2 className="text-base font-semibold text-slate-800">{t('coverPicker.title')}</h2>
          <button
            onClick={onClose}
        ...
        <div className="min-h-0 flex-1 overflow-y-auto p-4">
          {candidates.length === 0 ? (
            <p className="py-8 text-center text-sm text-slate-500">{t('coverPicker.empty')}</p>
          ) : (
