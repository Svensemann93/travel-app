...
import { PLACE_SORTS } from '../lib/placesList'
  ...
  return (
    <div className="mb-6 flex flex-wrap items-center gap-2">
      ...
      >
        ...
        <span className="hidden sm:inline">{t('groupByCountry')}</span>
      </button>
